...
/**
 * A2A Server v5 — 分层提示词 + LLM Router + 多适配器
 *
 * 🆚 v4 → v5 升级:
 *   ✅ 分层提示词系统 (a2a-layered-prompt.js)
 *   ✅ LLM Router 多适配器 (llm-router.js)
 *   ✅ 支持 OpenClaw / Hermes / OpenAI / direct 四种模式
 *   ✅ identity.llm 兜底 (兼容所有框架)
 *   ✅ 上下文生成器 (a2a-context-generator.js)
 *
 * 版本: 5.0.0 (A2A v0.6 + 分层提示词 v1) | 2026-07-24
 */
