    ...
    const commandImplementations = {
      ...
      'agent.configure': `
        (() => {
          ...
          // 读取 identity.json
          const identityPath = process.env.IDENTITY_PATH || '/home/node/.openclaw/workspace/csb-a2a-aip/identity.json';
      ...
      'agent.restart': `
        (() => {
          ...
          try {
            // 备份当前 PID
            const pidFile = '/home/node/.openclaw/workspace/csb-a2a-aip/server.pid';
            let oldPid = null;
            ...
            // 执行重启脚本
            const startScript = '/home/node/.openclaw/workspace/csb-a2a-aip/start.sh';
      ...
      'agent.update': `
        (() => {
          ...
          try {
            const a2aDir = '/home/node/.openclaw/workspace/csb-a2a-aip';
