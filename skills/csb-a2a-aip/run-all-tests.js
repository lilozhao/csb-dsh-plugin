#!/usr/bin/env node
/**
 * run-all-tests.js — CSB-Memory v0.4 全量测试运行器
 * 
 * 运行所有单元测试
...
const tests = [
  { name: 'memory.js', file: 'test-memory.js' },
  { name: 'lifecycle.js', file: 'test-lifecycle.js' },
  { name: 'value-scorer.js', file: 'test-value-scorer.js' }
];

async function runAllTests() {
  console.log('=== CSB-Memory v0.4 全量测试 ===\n');
